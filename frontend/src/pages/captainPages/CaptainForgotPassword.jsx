...
const CaptainForgotPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${apiBase}/api/captain/send-reset-password-otp`, {
      ...
      if (response.data.success) {
        ...
        navigate('/captain/reset-password', { state: { email: email.trim().toLowerCase() } })
      }
    } catch (err) {
          ...
          <div className='rounded-2xl glass-border glass-bg p-6 sm:p-8 backdrop-blur-md shadow-[0_8px_30px_rgb(0,0,0,0.35)]'>
            ...
            <div className='text-center'>
              ...
              <p className='mt-2 text-sm text-theme-secondary' style={{ fontFamily: 'Inter, system-ui' }}>
                Enter your captain email address and we'll send you a code to reset your password.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className='mt-8 space-y-6'>
              <div>
                ...
                <input
                  ...
                  placeholder='Enter your captain email address'
