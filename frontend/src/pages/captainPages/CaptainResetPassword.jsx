            ...
            <form onSubmit={handleSubmit} className='space-y-6'>
              ...
              <div>
                ...
                <div className='mt-4 text-center'>
                  <div className='text-xs text-gray-400 mb-2' style={{ fontFamily: 'Inter, system-ui' }}>
                    ⏱️ Code expires in: <strong className='text-white'>{formatTime(timeLeft)}</strong>
                  </div>
                  <button
                    type='button'
              ...
              <div className='space-y-4'>
                <div>
                  ...
                  <div className='mt-2 text-xs text-gray-400' style={{ fontFamily: 'Inter, system-ui' }}>
