        ...
        <section className='w-full max-w-md'>
          ...
          <div className='rounded-2xl glass-border glass-bg p-6 sm:p-8 backdrop-blur-md shadow-[0_8px_30px_rgb(0,0,0,0.35)]'>
            <div className='text-center'>
              ...
              <p className='mt-1 text-sm text-theme-secondary'>Ride better. Pay smarter with Sawari.pk.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className='mt-6 space-y-4'>
              ...
              <div>
                ...
                <div className='mt-2 flex items-center justify-end'>
                  <Link to='/passenger/forgot-password' className='text-xs text-theme-secondary hover:text-theme-primary'>
                    Forgot password?
                  </Link>
                </div>
              </div>
              ...
              <div className='mt-3 flex items-center justify-between text-xs text-theme-secondary'>
                ...
                <Link to='/passenger/register' className='font-medium text-theme-primary'>Create account</Link>
              </div>
